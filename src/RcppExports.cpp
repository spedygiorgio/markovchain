...
RcppExport SEXP markovchain_multinomCI2(SEXP transMatSEXP, SEXP seqMatSEXP, SEXP confidencelevelSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    ...
    Rcpp::traits::input_parameter< double >::type confidencelevel(confidencelevelSEXP);
    __result = Rcpp::wrap(multinomCI2(transMat, seqMat, confidencelevel));
    return __result;
END_RCPP
}
// multinomCI
