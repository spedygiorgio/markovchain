...
<<rCtmcInit, echo = TRUE, message=FALSE, warning=FALSE>>=
...
<<rctmcRandom0, echo = TRUE, message=FALSE, warning=FALSE>>=
...
<<rctmcSteadyStates, echo = TRUE, message=FALSE, warning=FALSE>>=
...
<<rctmcFitting, echo = TRUE, message=FALSE, warning=FALSE>>=
