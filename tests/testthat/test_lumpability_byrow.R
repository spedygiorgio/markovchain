...
test_that("lumpability methods are exported S4 methods", {
  expect_true("is.lumpable" %in% getNamespaceExports("markovchain"))
  expect_true("lump" %in% getNamespaceExports("markovchain"))
  expect_true("autoLump" %in% getNamespaceExports("markovchain"))
})
