...
## Usage and examples
```{r loadAndDoExample, echo = TRUE, message=FALSE, warning=FALSE, tidy=TRUE}
library(markovchain)
...
```{r MAPFit}
hyperMatrix<-matrix(c(1, 1, 2,3, 2, 1,2, 2, 3), nrow = 3,byrow=TRUE,
                    dimnames = list(weatherStates,weatherStates))
...
The results should not change changing us the order of the matrix.
