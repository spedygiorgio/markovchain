...
// is_stochastically_monotone_cpp
bool is_stochastically_monotone_cpp(NumericMatrix P);
RcppExport SEXP _markovchain_is_stochastically_monotone_cpp(SEXP PSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type P(PSEXP);
    rcpp_result_gen = Rcpp::wrap(is_stochastically_monotone_cpp(P));
    return rcpp_result_gen;
END_RCPP
}
// is_lumpable_cpp
bool is_lumpable_cpp(NumericMatrix P, List partition, double tol);
RcppExport SEXP _markovchain_is_lumpable_cpp(SEXP PSEXP, SEXP partitionSEXP, SEXP tolSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type P(PSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(is_lumpable_cpp(P, partition, tol));
    return rcpp_result_gen;
END_RCPP
}
// lump_cpp
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_markovchain_is_lumpable_cpp", (DL_FUNC) &_markovchain_is_lumpable_cpp, 3},
