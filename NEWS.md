...
10-05-2016 Version 0.4.4 rmarkovchain in RCpp (thanks to Deepak and GSOC
2016) Various small fixes
...
optimization (thanks to TAE) Initial support for Continuous Time Markov
Chains (thanks to SAI) Added new methods: names, !=
...
bootstap (thanks to Tae) Added bayesian Maximum A Posteriori estimation
(thanks to Sai)
...
since the package project has been selected within the funded GSOC 2015
projects. Thanks to Tae support now the fitting functions have been
rewritten in Rcpp.
...
21-06-2014 Version 0.0.9.5 Updated vignettes Added a method to convert a
square matrix into a markovchain object.

20-04-2014 Version 0.0.9 Updated vignette Added parallel processing for
...
`steadyStates` method. \* Adds the methods `recurrentStates` and
`transientClasses`. \* Makes the aforementioned methods work on by
column Markov chains. \* Improves tests, adding checking of mathematical
